    ...
    <header className="sticky top-0 z-40 border-b border-slate-200 bg-white/90 backdrop-blur">
      ...
      >
        <Link href={brandHref} className="text-lg font-extrabold text-slate-900">
          GovConnect <span className="text-red-600">DhakaGrid</span>
        </Link>
          ...
          {links.map((l) => {
            ...
            return (
              <Link
                ...
                className={`rounded-lg px-3 py-2 transition focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600 ${
                  active
